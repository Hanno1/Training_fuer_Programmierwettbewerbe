...
inline void sort_16_int(int *arr) {
    ...
    // line 1
    for (int i = 0; i < 8; i++){
        COEX(arr[2*i], arr[2*i+1]);
    }
    // line 2
    for (int i = 0; i < 13; i+=4){
        COEX(arr[i], arr[i+2]); COEX(arr[i+1], arr[i+3]);
    }
    // line 3
    for (int i = 0; i < 4; i++){
        COEX(arr[i], arr[i+4]); COEX(arr[i+8], arr[i+12]);
    }
    // line 4
    for (int i = 0; i < 8; i++){
        COEX(arr[i], arr[i+8]);
    ...
    // line 5
    COEX(arr[5], arr[10]); COEX(arr[6], arr[9]); COEX(arr[3], arr[12]);
    COEX(arr[7], arr[11]); COEX(arr[13], arr[14]);
    COEX(arr[1], arr[2]); COEX(arr[4], arr[8]);
    // line 6
    COEX(arr[1], arr[4]); COEX(arr[7], arr[13]);
    COEX(arr[2], arr[8]); COEX(arr[11], arr[14]);
    // line 7
    COEX(arr[2], arr[4]); COEX(arr[5], arr[6]); COEX(arr[9], arr[10]); COEX(arr[11], arr[13]);
    COEX(arr[3], arr[8]); COEX(arr[7], arr[12]);
    // line 8
    COEX(arr[3], arr[5]); COEX(arr[6], arr[8]); COEX(arr[7], arr[9]); COEX(arr[10], arr[12]);
    //line 9
    for (int i = 3; i < 12; i+=2){
        COEX(arr[i], arr[i+1]);
    }
    // line 10
    COEX(arr[6], arr[7]); COEX(arr[8], arr[9]);
}
/*************** end assignment ***************/
...
// 100000000
  ...
  // time standard: 110.142 seconds
  // time green: 18.1901 seconds
}
